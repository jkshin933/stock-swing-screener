...
if not GEMINI_API_KEY or not DISCORD_WEBHOOK_URL:
    raise ValueError("⚠️ 환경변수에 GEMINI_API_KEY 또는 DISCORD_WEBHOOK_URL이 설정되지 않았습니다.")
...
02  AWK  $27B  +1.6% 5.7% 0.71 5★
03  APH  $206B +2.1% 6.8% 0.67 4★
04  GE   $382B +1.3% 5.6% 0.89 4★
05  HWM  $115B +2.4% 7.2% 0.90 4★
06  MA   $499B +2.0% 5.1% 0.84 4★
07  DDOG $92B  +0.3% 14.6 0.83 4★
08  KO   $377B +2.0% 3.7% 0.58 4★
09  WFC  $269B +2.0% 8.3% 0.67 4★
...
01. APD - Air Products & Chemicals ($69B)
 • 사업/해자: 산업용 가스 글로벌 과점 공급망 및 장기 공급 계약
 • 7일내 뉴스: 청정에너지/수소 인프라 수주 확대 보도
 • 리스크: 글로벌 제조업 경기 둔화 시 산업용 수요 감소
 • 센티먼트: Strong Buy (수소 모멘텀) | 등급: A (+1★)

... (02번부터 10번까지 10개 기업 상세 작성)

### [SECTION 3]
⚖️ [STAGE 2-B: 촉매 보정 및 최종 재랭킹 (FINAL TOP 10)]
최종 종목 기존  점수변동 등급 핵심사유
01  APD (01) 5★->6★   A  독점가스/어닝無
02  APH (03) 4★->5★   A  AI커넥터 수요폭증
03  GE  (04) 4★->5★   A  항공엔진 MRO 호조
04  AWK (02) 5★->5★   B  수도유틸 방어우수
05  MA  (06) 4★->4★   B  결제망 견조/중립
06  HWM (05) 4★->4★   B  항공우주 밸류중립
07  DDOG(07) 4★->4★   B  클라우드/52W룸大
08  KO  (08) 4★->4★   B  필수소비재 배당형
09  WFC (09) 4★->4★   B  대형은행 마진안정
...
02  APH  $167.1 $163.8 $173.8 $178.5
03  GE   $368.4 $361.0 $383.2 $388.8
04  AWK  $136.2 $133.5 $141.6 $143.9
05  MA   $569.3 $557.9 $592.1 $598.0
